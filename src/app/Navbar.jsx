...
export default function Navbar() {
  ...
  const handleOverlayClick = (e) => {
    if (e.target === e.currentTarget) {
      // setSidebarAnimating(true); // Removed sidebar state
      // setTimeout(() => setSidebarOpen(false), 300); // Removed sidebar state
    }
  };
  ...
  const handleOpenSidebar = () => {
    // setSidebarOpen(true); // Removed sidebar state
    // setSidebarAnimating(false); // Removed sidebar state
  };

  // Reset animation state when sidebar opens
  // useEffect(() => { // Removed sidebar state
  //   if (sidebarOpen) {
  //     setSidebarAnimating(false);
  //   }
  // }, [sidebarOpen]); // Removed sidebar state

  // Always render the sidebar overlay and drawer for animation
  return (
    <>
      <nav
      ...
      {/* Sidebar Overlay and Drawer (always rendered for animation) */}
